export const cocreation = {
  title: "Governed co-creation, kept as a case study",
  lede:
  ...
  seats: [
    {
      seat: "Human direction",
      role: "Sets the questions, approves every mutation, and is the only seat that can promote something into the record as a claim. Accountable for everything published here.",
    },
    {
      seat: "Instrument seats",
      role: "Machine collaborators operating under approval membranes. They may draft, check, and object — they are never the sole author of a claim that enters the record.",
    },
    {
      seat: "The chronicle",
      role: "Holds derived claim identity, verified-by receipts, and supersession. It is what makes a later instance able to check an earlier one instead of trusting it.",
    },
    {
      seat: "The reader",
      role: "Every claim ships with a path to verify it independently. If the receipts do not let you check the work, the governance has failed regardless of what the process document says.",
    },
  ],
  pivot: {
    ...
    href: "https://github.com/templetwo/templetwo-retrospective",
  },
  letter: {
  ...
  repos: [
    ...
    },
    {
      ...
      blurb: "The public chronicle: derived claim identity, verified-by receipts, supersession.",
      href: "https://github.com/templetwo/sovereign-stack-chronicle",
    },
    {
      name: "templetwo-retrospective",
      blurb: "The audit of where the claims inflated, kept public rather than corrected away.",
      href: "https://github.com/templetwo/templetwo-retrospective",
    },
    {
      name: "t2helix",
      blurb: "The compass placed before the action — WITNESS denies, PAUSE gates, auto-distill quarantines.",
      href: "https://github.com/templetwo/t2helix",
    },
  ],
};
